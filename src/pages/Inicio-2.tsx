  ...
  return (
    <div className="animate-fade-up">
      ...
      <div className="stats-row">
        <div className="stat-card"><div className="stat-num">251</div><div className="stat-label">Alunos Matriculados</div></div>
        <div className="stat-card"><div className="stat-num">28</div><div className="stat-label">Professores</div></div>
